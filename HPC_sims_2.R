...
library(parallel)
DH100 <- mcmapply(1:100, FUN=testloop, MoreArgs = list(G=100 , test="Wald", estim="DiagH"),  mc.cores = getOption("mc.cores", 4L))
DH150 <- mcmapply(1:100, FUN=testloop, MoreArgs = list(G=150 , test="Wald", estim="DiagH"),  mc.cores = getOption("mc.cores", 4L))
DH200 <- mcmapply(1:100, FUN=testloop, MoreArgs = list(G=200 , test="Wald", estim="DiagH"),  mc.cores = getOption("mc.cores", 4L))
FH100 <- mcmapply(1:100, FUN=testloop, MoreArgs = list(G=100 , test="Wald", estim="FullH"),  mc.cores = getOption("mc.cores", 4L))
FH150 <- mcmapply(1:100, FUN=testloop, MoreArgs = list(G=150 , test="Wald", estim="FullH"),  mc.cores = getOption("mc.cores", 4L))
FH200 <- mcmapply(1:100, FUN=testloop, MoreArgs = list(G=200 , test="Wald", estim="FullH"),  mc.cores = getOption("mc.cores", 4L))
gc() # garb 
...
DH100A <- mcmapply(1:100, FUN=testloop_alt, MoreArgs = list(G=100 , test="Wald", estim="DiagH"),  mc.cores = getOption("mc.cores", 4L))
DH150A <- mcmapply(1:100, FUN=testloop_alt, MoreArgs = list(G=150 , test="Wald", estim="DiagH"),  mc.cores = getOption("mc.cores", 4L))
DH200A <- mcmapply(1:100, FUN=testloop_alt, MoreArgs = list(G=200 , test="Wald", estim="DiagH"),  mc.cores = getOption("mc.cores", 4L))
FH100A <- mcmapply(1:100, FUN=testloop_alt, MoreArgs = list(G=100 , test="Wald", estim="FullH"),  mc.cores = getOption("mc.cores", 4L))
FH150A <- mcmapply(1:100, FUN=testloop_alt, MoreArgs = list(G=150 , test="Wald", estim="FullH"),  mc.cores = getOption("mc.cores", 4L))
