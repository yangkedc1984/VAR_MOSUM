...
#
#
# ar1ScoreL1G400Boot <-  simMisspec(1000, G=400,p=1, test = "Score", estim = "DiagC", MS1,MS2,MS3, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# 
# ar1ScoreL2G400Boot <-  simMisspec(1000, G=400,p=2, test = "Score", estim = "DiagC", MS1,MS2,MS3, truelag = 2, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# 
# ar1ScoreL3G400Boot <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1,MS2,MS3, truelag = 3, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# 
# ar1ScoreL4G400Boot <-  simMisspec(1000, G=400,p=4, test = "Score", estim = "DiagC", MS1,MS2,MS3, truelag = 4, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# 


# ###
ar1ScoreL1G400NullBoot <-  simMisspec(500, G=400,p=1, test = "Score", estim = "DiagC", MS1,MS1,MS1, truelag = 1, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)

ar1ScoreL2G400NullBoot <-  simMisspec(500, G=400,p=2, test = "Score", estim = "DiagC", MS1,MS1,MS1, truelag = 2, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)

ar1ScoreL3G400NullBoot <-  simMisspec(500, G=400,p=3, test = "Score", estim = "DiagC", MS1,MS1,MS1, truelag = 3, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)

ar1ScoreL4G400NullBoot <-  simMisspec(500, G=400,p=4, test = "Score", estim = "DiagC", MS1,MS1,MS1, truelag = 4, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)

save.image("arpBootstrapNull.Rdata")

# 
# report(ar1ScoreL1G400Boot)
# report(ar1ScoreL2G400Boot)
# report(ar1ScoreL3G400Boot)
# report(ar1ScoreL4G400Boot)
# 
