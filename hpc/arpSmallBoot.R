...
#
# #
# d3Boot <-  simMisspec(1000, G=400,p=1, test = "Score", estim = "DiagC", MS1d3,MS2d3,MS3d3, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d3NullBoot <-  simMisspec(1000, G=400,p=1, test = "Score", estim = "DiagC", MS1d3,MS1d3,MS1d3, truelag = 1, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d3Bootp2 <-  simMisspec(1000, G=400,p=2, test = "Score", estim = "DiagC", MS1d3,MS2d3,MS3d3, truelag = 2, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d3NullBootp2 <-  simMisspec(1000, G=400,p=2, test = "Score", estim = "DiagC", MS1d3,MS1d3,MS1d3, truelag = 2, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d3Bootp3 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d3,MS2d3,MS3d3, truelag = 3, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d3NullBootp3 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d3,MS1d3,MS1d3, truelag = 3, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d3Bootp4 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d3,MS2d3,MS3d3, truelag = 4, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d3NullBootp4 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d3,MS1d3,MS1d3, truelag = 4, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# 
# 
# d5Boot <-  simMisspec(1000, G=400,p=1, test = "Score", estim = "DiagC", MS1d5,MS2d5,MS3d5, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d5NullBoot <-  simMisspec(1000, G=400,p=1, test = "Score", estim = "DiagC", MS1d5,MS1d5,MS1d5, truelag = 1, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d5Bootp2 <-  simMisspec(1000, G=400,p=2, test = "Score", estim = "DiagC", MS1d5,MS2d5,MS3d5, truelag = 2, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d5NullBootp2 <-  simMisspec(1000, G=400,p=2, test = "Score", estim = "DiagC", MS1d5,MS1d5,MS1d5, truelag = 2, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d5Bootp3 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d5,MS2d5,MS3d5, truelag = 3, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d5NullBootp3 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d5,MS1d5,MS1d5, truelag = 3, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d5Bootp4 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d5,MS2d5,MS3d5, truelag = 4, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d5NullBootp4 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d5,MS1d5,MS1d5, truelag = 4, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# 
# 
# d7Boot <-  simMisspec(1000, G=400,p=1, test = "Score", estim = "DiagC", MS1d7,MS2d7,MS3d7, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d7NullBoot <-  simMisspec(1000, G=400,p=1, test = "Score", estim = "DiagC", MS1d7,MS1d7,MS1d7, truelag = 1, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d7Bootp2 <-  simMisspec(1000, G=400,p=2, test = "Score", estim = "DiagC", MS1d7,MS2d7,MS3d7, truelag = 2, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d7NullBootp2 <-  simMisspec(1000, G=400,p=2, test = "Score", estim = "DiagC", MS1d7,MS1d7,MS1d7, truelag = 2, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d7Bootp3 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d7,MS2d7,MS3d7, truelag = 3, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d7NullBootp3 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d7,MS1d7,MS1d7, truelag = 3, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d7Bootp4 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d7,MS2d7,MS3d7, truelag = 4, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d7NullBootp4 <-  simMisspec(1000, G=400,p=3, test = "Score", estim = "DiagC", MS1d7,MS1d7,MS1d7, truelag = 4, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
