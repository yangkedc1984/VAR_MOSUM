...
#save.image("arpSmalld5.Rdata")



d10Null <- simMisspec(100, G=400,p=3, test = "Score", estim = "DiagC", MS1d10,MS1d10,MS1d10, truelag = 3, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=300)
d10 <- simMisspec(100, G=400,p=3, test = "Score", estim = "DiagC", MS1d10,MS2d10,MS3d10, truelag = 3, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=300)
