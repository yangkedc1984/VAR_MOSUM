...
# 
# #
# d5Boot <-  simMisspec(500, G=400,p=1, test = "Score", estim = "DiagC", MS1d5,MS2d5,MS3d5, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
# d5NullBoot <-  simMisspec(500, G=400,p=1, test = "Score", estim = "DiagC", MS1d5,MS1d5,MS1d5, truelag = 1, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
...
d7Boot <-  simMisspec(200, G=400,p=1, test = "Score", estim = "DiagC", MS1d7,MS2d7,MS3d7, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
#d7NullBoot <-  simMisspec(200, G=400,p=1, test = "Score", estim = "DiagC", MS1d7,MS1d7,MS1d7, truelag = 1, option = "ar1", criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=500)
...
save.image("arpSmalld7Null.Rdata")
