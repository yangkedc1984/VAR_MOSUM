...
# d15BS <- simMisspec(1000, G=500,p=1, test = "Score", estim = "DiagC", MS1d10,MS2d10,MS3d10, truelag =1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=300)
# d15BS_Null <- simMisspec(1000, G=500,p=1, test = "Score", estim = "DiagC", MS1d10,MS1d10,MS1d10, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=300)
# 
# d20BS <- simMisspec(1000, G=500,p=1, test = "Score", estim = "DiagC", MS1d10,MS2d10,MS3d10, truelag =1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=300)
# d20BS_Null <- simMisspec(1000, G=500,p=1, test = "Score", estim = "DiagC", MS1d10,MS1d10,MS1d10, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap = "multiplier", M=300)

save.image("arpd10BS.Rdata")
