...
diag15 <- diag(1,15)
# 
# null.05 <- simMisspec(1000, G=150,p=1, test = "Score", estim = "DiagC", 0.05*diag15,0.05*diag15,0.05*diag15, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap ="multiplier", M=300) 
# save.image("rhoDR.Rdata")
# null.10 <- simMisspec(1000, G=150,p=1, test = "Score", estim = "DiagC", 0.1*diag15,0.1*diag15,0.1*diag15, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap ="multiplier", M=300) 
# save.image("rhoDR.Rdata")
# null.15 <- simMisspec(1000, G=150,p=1, test = "Score", estim = "DiagC", 0.15*diag15,0.15*diag15,0.15*diag15, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap ="multiplier", M=300) 
# save.image("rhoDR.Rdata")
# null.20 <- simMisspec(1000, G=150,p=1, test = "Score", estim = "DiagC", 0.20*diag15, 0.20*diag15,0.20*diag15, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap ="multiplier", M=300) 
# save.image("rhoDR.Rdata")
# null.25 <- simMisspec(1000, G=150,p=1, test = "Score", estim = "DiagC", 0.25*diag15,0.25*diag15,0.25*diag15, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap ="multiplier", M=300) 

alt.05 <- simMisspec(1000, G=150,p=1, test = "Score", estim = "DiagC", 0.05*diag15,-0.05*diag15,0.05*diag15, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap ="multiplier", M=300) 
save.image("rhoDRalt.Rdata")
 alt.10 <- simMisspec(1000, G=150,p=1, test = "Score", estim = "DiagC", 0.1*diag15,-0.1*diag15,0.1*diag15, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap ="multiplier", M=300) 
 save.image("rhoDRalt.Rdata")
  alt.15 <- simMisspec(1000, G=150,p=1, test = "Score", estim = "DiagC", 0.15*diag15,-0.15*diag15,0.15*diag15, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap ="multiplier", M=300) 
  save.image("rhoDRalt.Rdata")
  alt.20 <- simMisspec(1000, G=150,p=1, test = "Score", estim = "DiagC", 0.20*diag15,-0.20*diag15,0.20*diag15, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap ="multiplier", M=300) 
  save.image("rhoDRalt.Rdata")
   alt.25 <- simMisspec(1000, G=150,p=1, test = "Score", estim = "DiagC", 0.25*diag15,-0.25*diag15,0.25*diag15, truelag = 1, option = "ar1",criterion = "eps", nu=0.2, global_resids = T, rm_cross_terms = T, do_bootstrap ="multiplier", M=300) 
# 
