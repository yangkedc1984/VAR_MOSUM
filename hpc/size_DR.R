...
n <- 1000
  ...
  n1000d15G8 <- simSize(1000, n, G, p=1, A1=MS1d15, option = "ar1")
  n1000d20G8 <- simSize(1000, n, G, p=1, A1=MS1d20, option = "ar1")
  
  G<- n/4
  n1000d10G4 <- simSize(1000, n, G, p=1, A1=MS1d10, option = "ar1")
  n1000d15G4 <- simSize(1000, n, G, p=1, A1=MS1d15, option = "ar1")
