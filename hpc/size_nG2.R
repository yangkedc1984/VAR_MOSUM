...
n <- 4000
  ...
  n4000d7G16_correct <- simSize(1000, n, G, p=1, A1=MS1d7)
  n4000d10G16_correct <- simSize(1000, n, G, p=1, A1=MS1d10 )#, option = "ar1")
  ...
  n4000d7G8_correct <- simSize(1000, n, G, p=1, A1=MS1d7)
 n4000d10G8_correct <- simSize(1000, n, G, p=1, A1=MS1d10)#, option = "ar1")
 ...
 # n4000d5G4 <- simSize(1000, n, G, p=1, A1=MS1d5)
  n4000d7G4_correct <- simSize(1000, n, G, p=1, A1=MS1d7)
  n4000d10G4_correct <- simSize(1000, n, G, p=1, A1=MS1d10 )#, option = "ar1")
...
save.image("simSize_nG2_correct.Rdata")
