...
get_Wkn_RCPP <- function(x, p, k, G, estim = "DiagC") {
    .Call(`_mosumvar_Wkn`, x, p, k, G, estim)
}

get_W_RCPP <- function(x, p, G, estim = "DiagC") {
...
test_Wald_RCPP <- function(x, p, G, alpha = 0.05, estim = "DiagC") {
...
MFA_Wald <- function(x, p, Gset, estim = "DiagC", alpha = 0.05) {
    .Call(`_mosumvar_MFA_Wald`, x, p, Gset, estim, alpha)
}
