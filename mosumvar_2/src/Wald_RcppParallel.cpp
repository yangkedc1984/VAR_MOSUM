...
double Wkn(arma::mat x, int p, int k, int G, String estim = "DiagC")
{
  int n = x.n_rows;
  int d = x.n_cols;
...
arma::vec W(arma::mat x, int p, int G, String estim = "DiagC") //int ncores=1)
{
...
List test_Wald(arma::mat x, int p, int G, double alpha =0.05, String estim = "DiagC"){
  int n = x.n_rows;
  int d = x.n_cols;
...
List MFA_Wald(arma::mat x, int p, arma::vec Gset, String estim = "DiagC", double alpha = 0.05){
